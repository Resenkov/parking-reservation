...
public class ParkingAdminController {
    ...
    @GetMapping("/lots/{id}")
    public ResponseEntity<ParkingLotResponse> getLot(
    ...
    @GetMapping("/zones")
    public ResponseEntity<List<ParkingZoneResponse>> getZones(
            @RequestParam(required = false) Long lotId) {
        return ResponseEntity.ok(parkingAdminService.getZones(lotId));
    }

    @GetMapping("/zones/{id}")
    public ResponseEntity<ParkingZoneResponse> getZone(
            @PathVariable @Positive(message = "id must be positive") Long id) {
    ...
    @PutMapping("/zones/{id}")
    public ResponseEntity<ParkingZoneResponse> updateZone(
            @PathVariable @Positive(message = "id must be positive") Long id,
    ...
    @GetMapping("/spots")
    public ResponseEntity<List<ParkingSpotResponse>> getSpots(
    ...
    @GetMapping("/spots/{id}")
    public ResponseEntity<ParkingSpotResponse> getSpot(
            @PathVariable @Positive(message = "id must be positive") Long id) {
